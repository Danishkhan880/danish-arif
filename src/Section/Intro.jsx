  ...
  return (
    ...
    >
      ...
      <div className="md:pr-20 lg:pr-45 text-center md:text-left">
        <Paragraph para="I build custom, high-performance websites and web applications using WordPress, blending design with robust back-end functionality." />
      </div>
